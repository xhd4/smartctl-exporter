...
// Run starts the vendored prometheus-community/smartctl_exporter HTTP server.
// args are kingpin flags (same as upstream CLI).
func Run(args []string) error {
	...
	return web.ListenAndServe(srv, toolkitFlags, logger)
}
